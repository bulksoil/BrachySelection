...
```{r}
bPC <- tidy_pcoa(b_data %>% select(SampleID, Generation, PlantID, Experiment, CollectionStage, Pressure, Presence, SoilType, otu, Log2RA, Run), value = "Log2RA", , dist = "bray", otus = "otu")
...
ggplot(cp_axes, aes(MDS1, MDS2, color = Pressure)) +
  geom_point()
```
